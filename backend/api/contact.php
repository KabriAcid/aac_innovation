...
try {
    ...
    $db = getDbConnection();
    $stmt = $db->prepare("
        INSERT INTO contacts (first_name, last_name, email, phone, company, service_interest, message, created_at) 
        VALUES (:firstName, :lastName, :email, :phone, :company, :serviceInterest, :message, NOW())
    ");
